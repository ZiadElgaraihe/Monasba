              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    SideBarItem(
                      title: 'Reviews',
                      icon: 'assets/icons/sidebar icons/review_fill.svg',
                      hasNotifications: false,
                      onTap: () {
                    ...
                    SideBarItem(
                      title: 'History',
                      icon: 'assets/icons/sidebar icons/history.svg',
                      hasNotifications: false,
                      onTap: () {
                    ...
                    SideBarItem(
                      title: 'Place Owner Services',
                      icon: 'assets/icons/sidebar icons/Add_round_fill.svg',
                      hasNotifications: false,
                      onTap: () {
                        Navigator.pushNamedAndRemoveUntil(
                            context, OwnerAppNavBar.id, (route) => false);
                      },
                    ),
